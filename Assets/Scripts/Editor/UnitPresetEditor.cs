...
[CustomEditor (typeof(UnitPreset))]
public class UnitPresetEditor : Editor {

	public override void OnInspectorGUI()
	{
		GUILayout.Label ("Unit Preset", EditorStyles.boldLabel);
		base.OnInspectorGUI ();

		UnitPreset unitPreset = (UnitPreset)target;

		EditorGUILayout.Space ();
		GUILayout.Label ("Agent Size");
