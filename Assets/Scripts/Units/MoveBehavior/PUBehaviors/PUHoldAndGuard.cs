...
public class PUHoldAndGuard : UnitMoveBehavior {
	...
	public override void UnitBehavior (Unit unit)
	{
		...
		{
			Unit newTarget = unit.LookForValidTarget (unit.transform.position, unit.unitPreset.attack.maxCastRange, unit.unitPreset.attack.minCastRange, unit.unitPreset.aggroTarget);
