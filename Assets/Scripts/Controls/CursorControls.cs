...
public class CursorControls : MonoBehaviour {
	...
	void Update ()
	{
		...
		if (Input.GetKey (KeyCode.Joystick1Button0) && squad1 != null)
		{
		...
		if (Input.GetKey (KeyCode.Joystick1Button1) && squad2 != null)
		{
		...
		if (Input.GetKey (KeyCode.Joystick1Button2) && squad3 != null)
		{
		...
		if (Input.GetKey (KeyCode.Joystick1Button3) && squad4 != null)
		{
